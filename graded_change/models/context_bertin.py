...
def extract_representations_bertin(dataset_dir, experiment_dir, device="cpu", **kwargs):
    ...
    model = AutoModelForMaskedLM.from_pretrained("bertin-project/bertin-roberta-base-spanish").to(device)
    model.eval()
